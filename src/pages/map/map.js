...
var MapPage = /** @class */ (function () {
    function MapPage(http, navCtrl, navParams, pubnub, MapData, arrivalGuides, cache, mapbox) {
        this.http = http;
  ...
  */
    MapPage.prototype.initMap = function () {
        ...
        this.MapData.getStopData(this.city).subscribe(function (res) {
            ...
            function oneachFeature(feature, layer) {
                ...
                layer.on('click', function (e) { _this.getETA(e); });
            }
            var myLayer = L.geoJSON(_this.markers, {
    ...
    //               });
    //                   }
    MapPage.prototype.getETA = function (stop) {
       ...
       ************************************************************************************************************************************************************/
        ...
        this.mapbox.getETA(waypoints).subscribe(function (res) {
            // console.log("what is in the data ", res);
            var eta = res;
            console.log(eta);
            var count = 1;
    ...
    MapPage = __decorate([
        ...
        __metadata("design:paramtypes", [Http, NavController, NavParams, PubNubAngular, MapDataProvider, ArrivalGuidesProvider, CacheService, MapBoxProvider])
    ], MapPage);
    return MapPage;
}());
export { MapPage };
